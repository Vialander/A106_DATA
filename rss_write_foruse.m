...
for num = 1:15
    ...
    name = fullfile('Sample_indoor',name_string);
    
    aa1 = fullfile('A106','indoor',str,name_num,'AP_A.dat');
    bb1 = fullfile('A106','indoor',str,name_num,'AP_B.dat');
    cc1 = fullfile('A106','indoor',str,name_num,'AP_C.dat');
    dd1 = fullfile('A106','indoor',str,name_num,'AP_D.dat');
